from keras.layers import Input, Add, Dense, Activation,Flatten,Convolution2D,MaxPooling2D,ZeroPadding2D,AveragePooling2D
from keras import backend as K
from RoiPoolingConv import RoiPoolingConv
from FixedBatchNormalization import FixedBatchNormalization

# !!! Removed TimeDistributed layer(conv_block_td and identity_block_td)
