...
config_output_filename = options.config.filename

with open(config_output_filename,'r') as f_in:
    C = pickle.load(f_in)

# turn off any data augmentation at test time
C.use_horizontal_filps = False
...
# define the base network ( resnet here, can be VGG, Incpetion, etc)
