#!/bin/bash
#BATCH --job-name=CPSPPSEResNet18
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/DNN/PyTorch/pytorch_imagenet/imagenet.py --netName=CPSPPSEResNet18 --bs=512
