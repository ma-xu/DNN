#!/bin/bash
#BATCH --job-name=PSPPSEResNet101
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/DNN/PyTorch/pytorch_imagenet/imagenet.py --netName=PSPPSEResNet101 --bs=512
