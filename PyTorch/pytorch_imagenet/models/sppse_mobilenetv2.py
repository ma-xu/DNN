...
class SPPSEMobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        super(SPPSEMobileNetV2, self).__init__()
...
def test():
    net = SPPSEMobileNetV2(num_classes=100)
