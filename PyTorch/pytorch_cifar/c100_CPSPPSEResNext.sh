#!/bin/bash
#BATCH --job-name=CPSPPSEResNeXt29
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/DNN/PyTorch/pytorch_cifar/cifar.py --netName=CPSPPSEResNeXt29 --bs=512 --cifar=100
