#!/bin/bash
#BATCH --job-name=CPSPPSEMobileNetV2
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/DNN/PyTorch/pytorch_cifar/cifar.py --netName=CPSPPSEMobileNetV2 --bs=256 --cifar=100
