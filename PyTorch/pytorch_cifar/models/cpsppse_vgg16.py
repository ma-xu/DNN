...
class VGGBlock(nn.Module):
    def __init__(self,in_channels, channels, stride=1):
        ...
        self.se = CPSPPSELayer(in_channel=in_channels,channel=channels)
...
class CPSPPSEVGG16(nn.Module):
    def __init__(self, num_classes=100,init_weights=True):
        super(CPSPPSEVGG16, self).__init__()
...
def test():
    net = CPSPPSEVGG16(num_classes=10)
